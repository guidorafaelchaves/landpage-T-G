export const businessUnits = [
  {
    ...
    short: 'Hub, fulfillment, cross docking e distribuição regional.',
    title: 'Infraestrutura para a operação ganhar velocidade.',
    description: 'Uma base em Arapiraca para receber, organizar, movimentar e expedir mercadorias com mais previsibilidade.',
    tone: 'orange',
    scene: 'warehouse',
  },
  {
    ...
    short: 'E-bikes, suporte, peças e soluções para operações.',
    title: 'Mobilidade desenhada para a cidade real.',
    description: 'Bicicletas elétricas e uma estrutura de apoio voltada a entregadores, empresas, condomínios e novos modelos urbanos.',
    tone: 'cyan',
    scene: 'mobility',
  },
  {
    ...
    number: '03',
    label: 'Energia solar',
    short: 'Projetos residenciais, empresariais e microgeração.',
    title: 'Energia limpa que trabalha todos os dias.',
    description: 'Soluções solares dimensionadas para reduzir custos e preparar residências e empresas para um futuro mais elétrico.',
    tone: 'gold',
    scene: 'solar',
  },
  {
    slug: 'carregadores',
    number: '04',
    label: 'Infraestrutura de recarga',
    short: 'Wallbox, totens e estações para espaços públicos e privados.',
    title: 'Onde existe movimento, pode existir recarga.',
    description: 'Infraestrutura para condomínios, empresas, shopping centers, postos e operações que já enxergam a transição elétrica.',
    tone: 'violet',
    scene: 'charging',
  },
]
